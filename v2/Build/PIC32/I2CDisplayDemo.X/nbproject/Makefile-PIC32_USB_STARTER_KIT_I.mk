...
${OBJECTDIR}/_ext/346134360/halUART.o: ../../../Source/HAL/PIC32/halUART.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CPPC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG   -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"../../../Demo/I2CDisplayDemo/Include" -I"../../../Demo/I2CDisplayDemo/Include/PIC32" -I"../../../Include" -I"../../../Library/PIC32/Harmony/Framework" -I"../../../Library/PIC32/FreeRTOS/Source/Include" -I"../../../Library/PIC32/FreeRTOS/Source/portable/MPLAB/PIC32MX" -I"../../../../../MD-DSP04" -ffunction-sections -mno-float -funroll-loops -fomit-frame-pointer -DHARDWARE_PIC32_USB_STARTER_KIT_I -MMD -MF "${OBJECTDIR}/_ext/346134360/halUART.o.d" -o ${OBJECTDIR}/_ext/346134360/halUART.o ../../../Source/HAL/PIC32/halUART.c    -DXPRJ_PIC32_USB_STARTER_KIT_I=$(CND_CONF)  $(COMPARISON_BUILD)  -std=gnu99 -mdfp="${DFP_DIR}"  
	@${FIXDEPS} "${OBJECTDIR}/_ext/346134360/halUART.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ 
