...
namespace eos {
    ...
    namespace spi {
        ...
        #ifdef _SPI1
        using SPIDevice1 = SPI_x<SPIChannel::channel1>;
        #endif
        #ifdef _SPI2
        using SPIDevice2 = SPI_x<SPIChannel::channel2>;
        #endif
        #ifdef _SPI3
        using SPIDevice3 = SPI_x<SPIChannel::channel3>;
        #endif
        #ifdef _SPI4
        using SPIDevice4 = SPI_x<SPIChannel::channel4>;
        #endif
        #ifdef _SPI5
        using SPIDevice5 = SPI_x<SPIChannel::channel5>;
        #endif
        #ifdef _SPI6
        using SPIDevice6 = SPI_x<SPIChannel::channel6>;
        #endif
