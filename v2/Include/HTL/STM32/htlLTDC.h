	...
	namespace ltdc {
		...
		class LTDCDevice final {
			...
			public:
				...
				void initHSYNCPin(LTDCPolarity polarity = LTDCPolarity::noChange) {
					gpio::GPIOAlt alt = internal::LTDCAltFunction<LTDCPin::HSYNC, pin_>::alt;
				...
				template <typename pin_>
				void initVSYNCPin(LTDCPolarity polarity = LTDCPolarity::noChange) {
					gpio::GPIOAlt alt = internal::LTDCAltFunction<LTDCPin::VSYNC, pin_>::alt;
					pin_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, alt);
					if (polarity == LTDCPolarity::activeHigh)
				...
				template <typename pin_>
				void initPCPin(LTDCPolarity polarity = LTDCPolarity::noChange) {
					gpio::GPIOAlt alt = internal::LTDCAltFunction<LTDCPin::PC, pin_>::alt;
					pin_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, alt);
					if (polarity == LTDCPolarity::activeHigh)
				...
				template <typename pin_>
				void initDEPin(LTDCPolarity polarity = LTDCPolarity::noChange) {
					gpio::GPIOAlt alt = internal::LTDCAltFunction<LTDCPin::DE, pin_>::alt;
					pin_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, alt);
					if (polarity == LTDCPolarity::activeHigh)
				...
				void initRPins() {
					pinR2_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::R2, pinR2_>::alt);
					pinR3_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::R3, pinR3_>::alt);
					pinR4_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::R4, pinR4_>::alt);
					pinR5_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::R5, pinR5_>::alt);
					pinR6_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::R6, pinR6_>::alt);
					pinR7_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::R7, pinR7_>::alt);
				}
				template <typename pinG2_, typename pinG3_, typename pinG4_, typename pinG5_, typename pinG6_, typename pinG7_>
				void initGPins() {
					pinG2_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::G2, pinG2_>::alt);
					pinG3_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::G3, pinG3_>::alt);
					pinG4_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::G4, pinG4_>::alt);
					pinG5_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::G5, pinG5_>::alt);
					pinG6_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::G6, pinG6_>::alt);
					pinG7_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::G7, pinG7_>::alt);
				}
				template <typename pinB2_, typename pinB3_, typename pinB4_, typename pinB5_, typename pinB6_, typename pinB7_>
				void initBPins() {
					pinB2_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::B2, pinB2_>::alt);
					pinB3_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::B3, pinB3_>::alt);
					pinB4_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::B4, pinB4_>::alt);
					pinB5_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::B5, pinB5_>::alt);
					pinB6_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::B6, pinB6_>::alt);
					pinB7_::getHandler()->initAlt(gpio::OutDriver::pushPull, gpio::Speed::fast, internal::LTDCAltFunction<LTDCPin::B7, pinB7_>::alt);
				}
				inline void enable() {
