...
extern const GPIORegs gpioRegs[];
...
#define halGPIOWritePort(portId, data) \
    *gpioRegs[portId].lat = (data)

#define halGPIOReadPort(portId) \
    *gpioRegs[portId].port
