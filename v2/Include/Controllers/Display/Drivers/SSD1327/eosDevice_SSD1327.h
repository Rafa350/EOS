#pragma once
#ifndef __eosDevice_SSD1327__
#define __eosDevice_SSD1327__
...
#define SSD1327_CMD_SET_ADDRESSING_MODE     0x20
#define SSD1327_CMD_SET_COLUMN              0x21
#define SSD1327_CMD_SET_PAGE                0x22
...
namespace eos {
    ...
    class Device_SSD1327 {
        private:
            Device_SSD1327(const Device_SSD1327 &) = delete;
            Device_SSD1327 & operator = (const Device_SSD1327 &) = delete;
    ...
    //         interficie SPI
    //
    class Device_SSD1327_SPI: public Device_SSD1327 {
        public:
        ...
        public:
            Device_SSD1327_SPI(Pin *pinCS, Pin *pinDC, Pin *pinRST, DevSPI *devSPI);
            ~Device_SSD1327_SPI();
    ...
    class Device_SSD1327_SPIDMA: public Device_SSD1327_SPI {
        public:
        ...
        public:
            Device_SSD1327_SPIDMA(Pin *pinCS, Pin *pinDC, Pin *pinRST, DevSPI *devSPI, DevDMA *devDMA);
