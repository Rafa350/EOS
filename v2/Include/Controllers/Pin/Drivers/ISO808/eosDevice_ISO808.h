...
namespace eos {
	...
	class DeviceX_ISO808 final: public Device_ISO808 {
		private:
			static Device_ISO808 _instance;
		...
		public:
            static constexpt uint8_t id = _id;
			static constexpr Device_ISO808 *pInst = &_instance;
			static constexpr Device_ISO808 &rInst = _instance;
	};
