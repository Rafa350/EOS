#ifndef __HARDWARE_PROFILE_SMT32F746G_DISC_H
#define __HARDWARE_PROFILE_SMT32F746G_DISC_H
...
//
#define RGBDIRECT_VRAM          ((uint32_t)0xD0000000)
...
//
#define RGBDIRECT_HSYNC_PORT    HAL_GPIO_PORT_C
#define RGBDIRECT_HSYNC_PIN     HAL_GPIO_PIN_6
#define RGBDIRECT_HSYNC_AF      HAL_GPIO_AF14_LTDC

// Control del pin VSYNC (Vertical sync)
//
#define RGBDIRECT_VSYNC_PORT    HAL_GPIO_PORT_A
#define RGBDIRECT_VSYNC_PIN     HAL_GPIO_PIN_4
#define RGBDIRECT_VSYNC_AF      HAL_GPIO_AF14_LTDC

// Control del pin DE (Display enable)
//
#define RGBDIRECT_DE_PORT       HAL_GPIO_PORT_F
