...
static PORTS_CHANNEL outPortChannel[eosCFG_OUTPUTS_NumOutputs] = {
    PORT_CHANNEL_D,
    PORT_CHANNEL_D,
    //PORT_CHANNEL_PORT_D
};

static PORTS_BIT_POS outPortBit[eosCFG_OUTPUTS_NumOutputs] = {
    PORTS_BIT_POS_0,
    PORTS_BIT_POS_1,
    //PORTS_BIT_POS_2
};

static PORTS_CHANNEL inpPortChannel[eosCFG_INPUTS_NumInputs] =  {
    PORT_CHANNEL_D,
    PORT_CHANNEL_D,
    PORT_CHANNEL_D
};

static PORTS_BIT_POS inpPortBit[eosCFG_INPUTS_NumInputs] = {
    PORTS_BIT_POS_6,
    PORTS_BIT_POS_7,
    PORTS_BIT_POS_13
};

static int inpPullUpChannel[eosCFG_INPUTS_NumInputs] = {
    CN15,
    CN16,
    CN19
};
 ...
 *
 *       Funcio:
 *           BOOL halPortRead(UINT8 inpupId)
 *
 *       Entrada:
