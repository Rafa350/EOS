...
export namespace htl::platform {
	...
	struct PlatformInfo {
		...
		static constexpr const char *manufacturer = "STMicroelectronics";
		static constexpr unsigned ramSize = 8 * 1024;
		static constexpr unsigned romSize = 64 * 1024;
	};

#elif defined(EOS_PLATFORM_STM32G071R8)
	struct PlatformInfo {
		static constexpr PlatformID id = PlatformID::stm32g071r8;
		static constexpr const char *name = "STM32G071R8";
		static constexpr const char *manufacturer = "STMicroelectronics";
