...
extern USBD_HandleTypeDef *hUsbDevices[];
...
///
uint8_t *USBD_VCP_DeviceDescriptor(
...
/// \retval Pointer to descriptor buffer
///
uint8_t *USBD_VCP_LangIDStrDescriptor(
	USBD_SpeedTypeDef speed,
	uint16_t *length) {
...
/// \retval Pointer to descriptor buffer
///
uint8_t *USBD_VCP_ProductStrDescriptor(
	USBD_SpeedTypeDef speed,
	uint16_t *length) {
...
/// \retval Pointer to descriptor buffer
///
uint8_t *USBD_VCP_ManufacturerStrDescriptor(
	USBD_SpeedTypeDef speed,
	uint16_t *length) {
...
/// \retval Pointer to descriptor buffer
///
uint8_t *USBD_VCP_SerialStrDescriptor(
	USBD_SpeedTypeDef speed,
	uint16_t *length) {
...
/// ºparam  speed: Current device speed
/// \param  length: Pointer to data length variable
/// \retval Pointer to descriptor buffer
///
uint8_t *USBD_VCP_ConfigStrDescriptor(
	USBD_SpeedTypeDef speed,
	uint16_t *length) {
...
/// \retval Pointer to descriptor buffer
///
uint8_t *USBD_VCP_InterfaceStrDescriptor(
	USBD_SpeedTypeDef speed,
	uint16_t *length) {
