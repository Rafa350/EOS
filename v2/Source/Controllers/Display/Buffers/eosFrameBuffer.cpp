...
export module Eos.Controllers.Display.Buffers;
...
export namespace eos {
	...
	class FrameBuffer {
		...
		public:
			FrameBuffer(int16_t frameWidth, int16_t frameHeight, Orientation orientation);
...
/// \param    frameWidth: Amplada fisica del display
/// \param    frameHeight: Alçada fisica del display
/// \param    orientation: Orientacio de les coordinades respecte a l'orientacio
///           fisica del display.
///
