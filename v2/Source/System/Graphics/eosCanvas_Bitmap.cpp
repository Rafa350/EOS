...
///
eos::Bitmap& eos::Bitmap::operator = (
	const Bitmap &bitmap) {
...
/// \param    El valor.
///
eos::ColorFormat eos::Bitmap::getFormat() const {

	return _impl->format;
}


int eos::Bitmap::getWidth() const {

	return _impl->width;
}


int eos::Bitmap::getHeight() const {

	return _impl->height;
}


void* eos::Bitmap::getPixels() const {
...
/// \return   El valor.
///
int eos::Bitmap::getBytesPerPixel() const {
...
/// \return   El valor.
///
int eos::Bitmap::getBytesPerLine() const {
